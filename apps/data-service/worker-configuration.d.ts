/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface BaseEnv` (hash: c23d0c05c80513162c8d70bdd74e2859)
// Runtime types generated with workerd@1.20251213.0 2025-04-01 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "AftonbladetFeedDurableObject";
	}
	interface Env {
		CLOUDFLARE_ACCOUNT_ID: string;
		CLOUDFLARE_DATABASE_ID: string;
		CLOUDFLARE_D1_TOKEN: string;
		AFTONBLADET_FEED_DO: DurableObjectNamespace<import("./src/index").AftonbladetFeedDurableObject>;
		DB: D1Database;
	}
}
